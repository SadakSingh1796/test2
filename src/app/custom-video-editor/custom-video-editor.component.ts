...
@Component({
  selector: 'app-custom-video-editor',
  templateUrl: './custom-video-editor.component.html',
  styleUrls: ['./custom-video-editor.component.scss']
})
export class CustomVideoEditorComponent  {
  name = 'Angular ' + VERSION.major;
  url = "https://stream.mux.com/22eyC2mYPtcPjuCE1FK4cs5Xx01oTqncR3XXPWADegpI/high.mp4"
